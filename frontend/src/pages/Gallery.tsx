    ...
    <div className="space-y-6">
      ...
      {search && (
        <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-4 sm:p-6">
          <h2 className="font-semibold">Tìm trong ký ức của bạn</h2>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                {visibleJourneys.map((j) => (
                  <Link
                    key={j.id}
                    to={"/journey/" + j.id}
                    className="space-y-2 rounded-2xl border border-slate-200 bg-white p-5 hover:border-teal-200"
                  >
                    ...
                    <span className="block pt-2 text-sm text-teal-700">
                      Xem chuyến đi →
                    </span>
                  </Link>
                ))}
              ...
              <EmptyState>
                {query && search ? (
                  ...
                  <>
                    ...
                    <Link className="text-teal-700 underline" to="/upload">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                {visiblePlans.map((p) => (
                  ...
                  >
                    ...
                    <h3 className="font-semibold">{p.criteria.destination}</h3>
              ...
              <EmptyState>
                {query && search ? (
                  ...
                  <>
                    ...
                    <Link className="text-teal-700 underline" to="/planner">
                      Tạo kế hoạch mới
                    </Link>
                  </>
                )}
