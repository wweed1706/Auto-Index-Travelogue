...
const TimelineView = ({ timeline = [] }: { timeline?: TimelineNode[] }) => {
  ...
  return (
    <div className="relative pl-6 sm:pl-8 md:pl-10 before:absolute before:left-3 sm:before:left-4 md:before:left-5 before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-teal-500 before:via-teal-500 before:to-slate-300">
      <div className="space-y-8 sm:space-y-10">
        {displayTimeline.map((node, index) => (
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-200/80 shadow-sm hover:shadow-sm hover:border-teal-200 transition-all duration-300">
              {/* Giờ / Ngày tháng */}
