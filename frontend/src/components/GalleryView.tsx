    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
          {filteredPhotos.map((photo) => (
            <div
              ...
              className="group relative aspect-square overflow-hidden rounded-2xl bg-slate-100 border border-slate-200/60 shadow-sm hover:shadow-sm transition-all duration-300 cursor-pointer"
            >
      ...
      {activePhotoModal && (
        <Modal title={activePhotoModal.title} onClose={handleCloseModal}>
          <div
            className="relative max-w-3xl w-full bg-white rounded-2xl overflow-hidden shadow-sm border border-white/10"
