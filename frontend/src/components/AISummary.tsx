...
const AISummary = ({
  ...
  if (isLoading) {
    return (
      <div className="rounded-2xl p-[1.5px] border border-slate-200 bg-white animate-pulse shadow-sm">
  ...
  return (
    <div className="relative rounded-2xl p-[1.5px] border border-slate-200 bg-white shadow-sm  animate--up">
      <div className="bg-white/95 backdrop-blur-md rounded-[22px] p-5 sm:p-7 space-y-5">
        {/* Header Kết quả AI */}
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-50 text-teal-700 text-xs font-bold border border-teal-200/60 shadow-sm">
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-teal-50/60 via-slate-50 to-teal-50/50 border border-teal-100/80">
          ...
          {stats && (
            <div className="flex flex-wrap items-center gap-3 mt-3 pt-3 border-t border-teal-100/60 text-xs font-semibold text-teal-900">
              {stats.places && (
            ...
            <div className="flex items-center gap-3 overflow-x-auto pb-2 ">
              {validPhotos.map((photo) => (
                <div
                  ...
                  className="w-44 sm:w-52 shrink-0 aspect-[4/3] rounded-2xl overflow-hidden bg-slate-100 relative group cursor-pointer border border-slate-200/80 shadow-sm hover:shadow-sm transition-all duration-300"
                >
                  <img
                    src={photo.url}
      ...
      {activePhoto && (
        <Modal title={activePhoto.title} onClose={() => setActivePhoto(null)}>
          <div
            className="relative max-w-2xl w-full bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-white/10"
